 ...
 */
exports.ApplyCardSecurityQuestions = async (req, res) => {
	...
	if (req.method === "OPTIONS") {
		...
		try {
			...
			let response = await getSecurityQuestions(req); 
...
const getSecurityQuestions = async (req) => {
  let headerPassword = process.env.headerPassword;
	console.log(req.body);
	return await axios.post(`${process.env.baseUrl}/cards/get-security-questions`, 
		req.body, 
		{
			headers: {
