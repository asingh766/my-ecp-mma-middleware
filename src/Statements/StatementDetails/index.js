exports.StatementDetails = async (req, res) => {
...
const getStatementData = async (req) => {
	...
	return await axios.get(`${process.env.baseUrl}/users/${req.query.userId}/accounts/${req.query.accountNo}/statement-details`, 
		{
			headers: {
